C   EXPOS:      BLKDAT.FOR             Version Date: 12-May-98        
...
C  Last Modified:    12-May-1998  BAN                                      *
C                                                                            *
C*****************************************************************************
C
...
C                  from m2 to kg.
C  12-May-98  BAN  Removed OPT.CMN; put in BLOCKD
C==== SUBROUTINE CALL ========================================================
C
      BLOCK DATA BLKDAT
C
...
C
      DATA NERR,NGID,NWFF,NWCF,NELS,NIDF,NRMD/51,52,57,58,60,61,2/
...
C
     ...
     .             9,9,4,8,9,4/
      ...
      DATA NEXPUN/6,6,5,9*5,4,4,4,5,4,4*5,6,4,4,5,4,5,6/
C
