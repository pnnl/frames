...
Begin VB.Form frmRunAPlume 
   ...
   End
End
Attribute VB_Name = "frmRunAPlume"
...
Private Sub Form_Load()
    ...
    If argc >= 5 Then
        ...
        If Dir(runcode) = "" Then
            etext = "Unabled to find acutesrc.exe - reinstall codes"
            put_val errfile, etext
            put_line errfile
            MsgBox etext
            close_csv errfile
