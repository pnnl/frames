...
Begin VB.Form frmInpAcPlm 
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      Begin VB.Frame frmSrc 
         ...
         Begin VB.Frame frmBld 
            ...
            Begin FPSpread.vaSpread spdEnch 
               ...
               SpreadDesigner  =   "AcutePlume.frx":0342
               VisibleCols     =   2
               VisibleRows     =   10
            End
      ...
      Begin TabDlg.SSTab SrcTab 
         ...
         TabPicture(0)   =   "AcutePlume.frx":050F
         Tab(0).ControlEnabled=   -1  'True
         Tab(0).ControlCount=   0
         TabCaption(1)   =   "Soucre 2"
         TabPicture(1)   =   "AcutePlume.frx":052B
         Tab(1).ControlEnabled=   0   'False
         Tab(1).ControlCount=   0
         TabCaption(2)   =   "Source 3"
         TabPicture(2)   =   "AcutePlume.frx":0547
         Tab(2).ControlEnabled=   0   'False
         Tab(2).ControlCount=   0
         TabCaption(3)   =   "Source 4"
         TabPicture(3)   =   "AcutePlume.frx":0563
         Tab(3).ControlEnabled=   0   'False
         Tab(3).ControlCount=   0
         TabCaption(4)   =   "Source 5"
         TabPicture(4)   =   "AcutePlume.frx":057F
      ...
      Begin TabDlg.SSTab SSTab3 
         ...
         TabPicture(0)   =   "AcutePlume.frx":059B
         Tab(0).ControlEnabled=   -1  'True
         Tab(0).Control(0)=   "Frame1"
         Tab(0).Control(0).Enabled=   0   'False
         Tab(0).ControlCount=   1
         TabCaption(1)   =   "Model Parameters"
         TabPicture(1)   =   "AcutePlume.frx":05B7
         Tab(1).ControlEnabled=   0   'False
         ...
         TabPicture(2)   =   "AcutePlume.frx":05D3
         Tab(2).ControlEnabled=   0   'False
         Tab(2).Control(0)=   "Frame4"
         Tab(2).Control(0).Enabled=   0   'False
         Tab(2).ControlCount=   1
         TabCaption(3)   =   "Meteorlogical Files"
         TabPicture(3)   =   "AcutePlume.frx":05EF
         Tab(3).ControlEnabled=   0   'False
         ...
         Begin VB.Frame Frame2 
            ...
            Begin VB.ComboBox hr 
               Height          =   288
               ItemData        =   "AcutePlume.frx":060B
               Left            =   1248
               List            =   "AcutePlume.frx":0657
               Style           =   2  'Dropdown List
               TabIndex        =   51
               Top             =   480
               Width           =   780
         ...
         Begin VB.Frame frmCalm 
            ...
            Begin FPSpread.vaSpread spdCalm 
               ...
               ScrollBars      =   2
               ScrollBarShowMax=   0   'False
               SpreadDesigner  =   "AcutePlume.frx":0769
               VisibleCols     =   1
               VisibleRows     =   6
            End
            Begin VB.Label lblref 
         ...
         Begin VB.Frame Frame1 
            ...
            Begin VB.ComboBox cboUnit 
               Height          =   288
               Index           =   9
               ItemData        =   "AcutePlume.frx":0968
               Left            =   4704
               List            =   "AcutePlume.frx":096A
               Style           =   2  'Dropdown List
               TabIndex        =   4
               Tag             =   "m"
               Top             =   480
            ...
            Begin FPSpread.vaSpread spdRadii 
               ...
               MaxRows         =   10
               ScrollBarExtMode=   -1  'True
               SpreadDesigner  =   "AcutePlume.frx":096C
               UserResize      =   0
               VisibleCols     =   1
               VisibleRows     =   10
            End
