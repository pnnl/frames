...
Begin VB.Form frmInpChPlm 
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      Begin TabDlg.SSTab SrcTab 
         ...
         TabPicture(0)   =   "ChronicPlume.frx":0447
         Tab(0).ControlEnabled=   -1  'True
         Tab(0).ControlCount=   0
         TabCaption(1)   =   "Source 2"
         TabPicture(1)   =   "ChronicPlume.frx":0463
         Tab(1).ControlEnabled=   0   'False
         Tab(1).ControlCount=   0
         TabCaption(2)   =   "Source 3"
         TabPicture(2)   =   "ChronicPlume.frx":047F
         Tab(2).ControlEnabled=   0   'False
         Tab(2).ControlCount=   0
         TabCaption(3)   =   "Source 4"
         TabPicture(3)   =   "ChronicPlume.frx":049B
         Tab(3).ControlEnabled=   0   'False
         Tab(3).ControlCount=   0
         TabCaption(4)   =   "Source 5"
         TabPicture(4)   =   "ChronicPlume.frx":04B7
      ...
      Begin TabDlg.SSTab SSTab3 
         ...
         TabPicture(0)   =   "ChronicPlume.frx":04D3
         Tab(0).ControlEnabled=   -1  'True
         Tab(0).Control(0)=   "Frame1"
         Tab(0).Control(0).Enabled=   0   'False
         Tab(0).ControlCount=   1
         TabCaption(1)   =   "Model Parameters"
         TabPicture(1)   =   "ChronicPlume.frx":04EF
         Tab(1).ControlEnabled=   0   'False
         ...
         TabPicture(2)   =   "ChronicPlume.frx":050B
         Tab(2).ControlEnabled=   0   'False
         Tab(2).Control(0)=   "Frame4"
         Tab(2).Control(0).Enabled=   0   'False
         Tab(2).ControlCount=   1
         TabCaption(3)   =   "Meteorlogical Files"
         TabPicture(3)   =   "ChronicPlume.frx":0527
         Tab(3).ControlEnabled=   0   'False
         ...
         Begin VB.Frame frmCalm 
            ...
            Begin FPSpread.vaSpread spdCalm 
               ...
               MaxRows         =   16
               ScrollBars      =   2
               SpreadDesigner  =   "ChronicPlume.frx":05EB
               VisibleCols     =   500
               VisibleRows     =   500
            End
            Begin VB.Label lblref 
         ...
         Begin VB.Frame Frame1 
            ...
            Begin FPSpread.vaSpread spdRadii 
               ...
               SpreadDesigner  =   "ChronicPlume.frx":072F
               VisibleCols     =   500
               VisibleRows     =   500
            End
            Begin VB.ComboBox cboUnit 
               Height          =   288
               Index           =   9
               ItemData        =   "ChronicPlume.frx":0873
               Left            =   4704
               List            =   "ChronicPlume.frx":0875
               Style           =   2  'Dropdown List
               TabIndex        =   4
               Tag             =   "m"
               Top             =   480
...
Private Sub Form_load()
  ...
  If argc >= 5 Then
    ...
    frmInpChPlm.Caption = "GENII Chronic Plume Model - " + modName
