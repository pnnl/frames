...
Begin VB.Form frmInpChPuff 
   ...
   Begin TabDlg.SSTab SSTab3 
      ...
      Begin TabDlg.SSTab SSTab2 
         ...
         TabHeight       =   420
         TabCaption(0)   =   "Nodes"
         TabPicture(0)   =   "ChronicPuff.frx":037A
         Tab(0).ControlEnabled=   -1  'True
         Tab(0).Control(0)=   "Frame1"
         Tab(0).Control(0).Enabled=   0   'False
         Tab(0).ControlCount=   1
         TabCaption(1)   =   "Surface Roughness"
         TabPicture(1)   =   "ChronicPuff.frx":0396
         Tab(1).ControlEnabled=   0   'False
         ...
         Begin VB.Frame Frame9 
            ...
            Begin FPSpread.vaSpread spdGrid 
               ...
               BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
                  ...
                  Strikethrough   =   0   'False
               EndProperty
               SpreadDesigner  =   "ChronicPuff.frx":03B2
               VisibleCols     =   5
               VisibleRows     =   8
            End
      ...
      Begin TabDlg.SSTab SrcTab 
         ...
         TabPicture(0)   =   "ChronicPuff.frx":0598
         Tab(0).ControlEnabled=   -1  'True
         Tab(0).ControlCount=   0
         TabCaption(1)   =   "Source 2"
         TabPicture(1)   =   "ChronicPuff.frx":05B4
         Tab(1).ControlEnabled=   0   'False
         Tab(1).ControlCount=   0
         TabCaption(2)   =   "Source 3"
         TabPicture(2)   =   "ChronicPuff.frx":05D0
         Tab(2).ControlEnabled=   0   'False
         Tab(2).ControlCount=   0
         TabCaption(3)   =   "Source 4"
         TabPicture(3)   =   "ChronicPuff.frx":05EC
         Tab(3).ControlEnabled=   0   'False
         Tab(3).ControlCount=   0
         TabCaption(4)   =   "Source 5"
         TabPicture(4)   =   "ChronicPuff.frx":0608
      ...
      Begin TabDlg.SSTab SSTab1 
         ...
         TabsPerRow      =   2
         TabHeight       =   423
         TabCaption(0)   =   "Puff Controls"
         TabPicture(0)   =   "ChronicPuff.frx":0624
         Tab(0).ControlEnabled=   -1  'True
         Tab(0).Control(0)=   "Frame4"
         Tab(0).Control(0).Enabled=   0   'False
         Tab(0).ControlCount=   1
         TabCaption(1)   =   "Other Controls"
         TabPicture(1)   =   "ChronicPuff.frx":0640
         Tab(1).ControlEnabled=   0   'False
         ...
         Begin VB.Frame Frame4 
            ...
            Begin VB.ComboBox cboTimeStep 
               Height          =   288
               ItemData        =   "ChronicPuff.frx":065C
               Left            =   4800
               List            =   "ChronicPuff.frx":067E
               Style           =   2  'Dropdown List
               TabIndex        =   61
               Top             =   384
               Width           =   1000
   ...
   End
End
Attribute VB_Name = "frmInpChPuff"
...
Private Sub Form_load()
  ...
  If argc >= 5 Then
    ...
    frmInpChPuff.Caption = "GENII Chronic Puff Model - " + modName
