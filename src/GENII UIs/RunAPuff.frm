...
Private Sub Form_Load()
    ...
    If argc >= 5 Then
        ...
        If Dir(runcode) = "" Then
            etext = "Unabled to find pufacute.exe - reinstall codes"
            put_val errfile, etext
            put_line errfile
            MsgBox etext
            close_csv errfile
    ...
    If Dir(LTrim(RTrim(RunName)) + ".ERP") <> "" Then
        put_val errfile, "Error running Pufacute.exe"
        put_line errfile
        close_csv errfile
