C   EXPOS:      GETNAM.FOR             Version Date: 14-May-97               
...
C  Last Modified:    14-May-1997  DLS                                        *
C                                                                            *
C*****************************************************************************
C
...
c    6 REWIND (NIDF)
cC
cC  Find input record with RECTYP = 2: Name for Case output files (ELS,
cC                                     EPF, and ERR)
cC   
...
c   11 REWIND (NIDF)
cC
cC  Find input record with RECTYP=3: Number of Site to use
cC NSITE
...
c   16 REWIND(NIDF)
cC
cC  Find input record with RECTYP=4: Number of exposure location
cC  EXPNUM
cC
...
c   21 REWIND(NIDF)
cC
cC  Find input record with RECTYP = 5: Name for glyph (ExpName)
cC   
