...
Public Function ReadConfigFile(stfilename As String)
...
Dim GetEXEPath As String
    ...
    gstFirstFile = inStream.ReadLine
    If gstFirstFile <> vbNullString Then
        Command1.Enabled = True
    End If
    
    gstSecondFile = inStream.ReadLine
    If gstSecondFile <> vbNullString Then
        Command2.Enabled = True
    End If
    gstThirdFile = inStream.ReadLine
    If gstThirdFile <> vbNullString Then
        Command3.Enabled = True
    End If
     gstFourthFile = inStream.ReadLine
    ...
    gstFifthFile = inStream.ReadLine
      If gstFifthFile <> vbNullString Then
        Command5.Enabled = True
    End If
    gstSixthFile = inStream.ReadLine
      If gstSixthFile <> vbNullString Then
        Command6.Enabled = True
    End If
        
    gstSeventhFile = inStream.ReadLine
      If gstSeventhFile <> vbNullString Then
        Command7.Enabled = True
    End If
    gstEightthFile = inStream.ReadLine
...
Private Sub cmdGetURL_Click()
 On Error Resume Next
    ...
    ReadConfigFile (txtFileName.Text)
End Sub
