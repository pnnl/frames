...
Begin VB.Form PlusUI 
   ...
   Begin VB.ComboBox Combo1 
      Height          =   315
      ItemData        =   "plusUI.frx":0442
      Left            =   4080
      List            =   "plusUI.frx":0444
      Style           =   2  'Dropdown List
      TabIndex        =   0
      Tag             =   "m^3/yr"
      Top             =   840
              ...
              If read_parmrec(fle, temp) Then
                Select Case temp.pName
                  ...
                  Case "flux", "percentflux":
                    If temp.cunit = Combo1.Tag And temp.pName = Text1.Tag Then
                      modfillet 0
                    End If
                End Select
              End If
