...
c
     ...
     .     MEVSV /1.385E-5/, RAIN/1./, LML/0.001/
...
C     Inventory units--
C      DATA NVU   /3.7E-2, 3.7E+4, 3.7E+7, 3.7E+10, 1.0/
C      DATA UNIT1 /'pCi',   'uCi',  'mCi',  ' Ci', ' Bq'/
C      DATA UNIT2 /'m3','yr','m2',10*'yr',3*'L',5*'yr','m3','m3',' '/
C      DATA UNIT3 /'m2','m3','kg'/
C      DATA SVU /1.0, 0.15, 224.0/
